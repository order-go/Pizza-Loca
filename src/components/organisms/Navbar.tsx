...
const Navbar=() => {
  ...
  return (
    <>
      <div className='z-50 top-0 fixed h-10 w-full flex flex-row-reverse justify-between items-center px-4 pt-2 bg-primary box-shadow1 text-white text-lg'>
        <div className='flex flex-row gap-2'>
          <Title color='text-fourth' title={'PIZZA LOCA'} />
          <IconBotle
